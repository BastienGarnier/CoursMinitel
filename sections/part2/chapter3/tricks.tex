...
\label{sub:un_peu_d_imagination}
...
\end{minted}
Le défi est évidemment de comprendre ce que fait ce programme, et comment il le fait, hihihi !\footnote{(rire vraiment très diabolique)}
\end{document}