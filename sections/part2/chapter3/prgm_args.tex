...
\exercise{Liste des arguments} Écrire un programme qui affiche toute la liste des arguments passés au programme, c'est-à-dire tel que :
\begin{minted}{bash}
...
user@computer ~/working_directory>
\end{minted}
\exercise{Un cat minimaliste} L'objectif est de reproduire le comportement minimal de la commande \textit{cat} du terminal. \\
