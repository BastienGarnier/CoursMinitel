...
\end{array}\right.
$$
\exercise{Nombres premiers}Écrire un programme qui demande à l'utilisateur de saisir un nombre $N$ et vérifie si $N$ est premier. On essaiera d'avoir un maximum de $\sqrt{N}$ tours de boucle. On justifiera la correction du programme.\footnote{C'est-à-dire une démonstration que ce programme résout bien le problème.}
\end{document}