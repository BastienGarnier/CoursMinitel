...
\exercise{Matrices} L'objet de cet exercice est l'implantation de matrices en langage C. 
...
\forall i \in \llbracket{0; n\llbracket & L_{i} & = & \left(a_{i, 0}, \dots, a_{i, m-1} \right)}
\end{array}$$
\end{document}