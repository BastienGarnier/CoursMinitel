...
\end{enumerate}
\newpage
\exercise{Recherche dichotomique} On reprend les notations introduites dans l'\refexercise{Routines classiques de manipulation de tableaux}.
\begin{enumerate}
