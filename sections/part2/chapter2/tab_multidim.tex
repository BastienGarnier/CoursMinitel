...
\end{minted}
\exercise{Afficher un tableau $2d$ [COURS]} Écrire un programme (et pas une routine) qui affiche les éléments d'un tableau $2d$ d'entiers.
...
\end{minted}
\exercise{Affichage du triangle [COURS]} Compléter le programme ci-dessus pour remplir le tableau \ref{math:triangle_2d_array}. Écrire ensuite une procédure \textsf{print\_triangle(int **triangle, int n\_lines);} qui affiche ce tableau (où \textsf{n\_lines} désigne le nombre de lignes du tableau)
...
\exercise{Matrices (1)} L'objet de cet exercice est l'implantation de matrices en langage C. 
