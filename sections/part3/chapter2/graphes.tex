...
\underline{\textbf{Complexités temporelles des routines de test et de parcours :}}\newline
...
\end{enumerate}
\exercise{Pour le plaisir de l'optimalité}{25}
\begin{enumerate}
...
\exercise{Plus court chemin}{20} Soit $G = (S, A)$ un graphe orienté. Soit $s\in S$ fixé.
\begin{enumerate}
