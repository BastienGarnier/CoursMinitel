...
\begin{center}
	...
	\draw (4) -- (6);
	\end{tikzpicture} 
	\captionof{figure}{Un ABR\label{fig:abre_bin}}
\end{center}
...
$\textit{Booleen } G = \textit{Vrai}$ \tcp*{Gauche = Vrai}
$\textit{Booleen } D = \textit{Faux}$ \tcp*{Droite = Faux}
...
\Return $T$ \tcp*{On suppose modifier $Parent\Rightarrow$ modifier $T$}
\end{algorithm}
