...
\Indm\nonl\parcoursrecursif{$A:ArbreBinaire$, $p:Procedure$} \\
\Indp
\Switch {$A$} {
...
\KwIn{$A:\textit{ABR\textless{}Element\textgreater}, x:Element$}
...
\Indm\nonl\abrinserer{$A:ABR$, $x:Element$} \\
\Indp
\Switch {$A$} {
	\Case {$A = E$} {
		\Return $(E, x, E)$
...
\Indm\nonl\parcoursrecursif{$A:ABR$, $x:Element$} \\
\Indp
\Case {$A = (g, y, E)$} {
	\Return $g$
}
...
\Indm\nonl\abrsupprimer{$A:ABR$, $x:Element$} \\
\Indp
\Switch {$A$} {
	\Case {$A = E$} {
...
\KwIn{$L:\textit{Liste\textless{}Element\textgreater}$}
