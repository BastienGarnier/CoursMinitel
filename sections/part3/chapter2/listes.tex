...
\exercise{Piles et files}{20} Montrer qu'on peut implanter une file avec deux piles et une pile avec deux files. Quelle est la complexité temporelle amortie des opérations ?
