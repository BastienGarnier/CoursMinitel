...
\part{Le vrai monde de la réalité réelle}
	...
	\chapter{Méthodes de programmation propre}
		...
		\section{Benchmarks}
		\subfile{sections/part3/chapter2/benchmarks}
	...
	\chapter{Pour s'entraîner et s'amuser}
		...
		\section{Rogue-Like}
			\subfile{sections/part3/chapter3/roguelike}
		\section{Allocation dynamique}
			\subfile{sections/part3/chapter3/allocationdynamique}
		\section{Reseaux neuronaux}
			\subfile{sections/part3/chapter3/reseauxneuronaux}
\part{Annexes}
